...
from backend.app.modules import Profile
from backend.app.modules import CreateProfile, UpdateProfile
...
def update_profile(user_data: UpdateProfile, db: Session) -> Profile | None:
